...
class Merlin_Redux_Importer {
    ...
    public static function import($import_data) {
        ...
        foreach ($import_data as $redux_item) {
            $redux_options_raw_data = westio_get_file_contents($redux_item['file_path']);
            ...
            if (isset($redux_framework->args['opt_name'])) {
                ...
                Merlin_Logger::get_instance()->debug(esc_html__('The Redux Framework data was imported', 'westio'), $redux_item);
            }
        }
