...
/**
 * Class Westio_Elementor_Custom_Shapes
 *
 * Main Plugin class
 * @since 0.0.1
 */
class Westio_Elementor_Custom_Shapes {
    ...
    public function __construct() {
        $labels = array(
            'name'                  => _x('Custom shapes', 'Post Type General Name', 'westio'),
            'singular_name'         => _x('Custom shape', 'Post Type Singular Name', 'westio'),
            'menu_name'             => __('Custom shapes', 'westio'),
            'name_admin_bar'        => __('Custom shape', 'westio'),
            'archives'              => __('Item Archives', 'westio'),
            'attributes'            => __('Item Attributes', 'westio'),
            'parent_item_colon'     => __('Parent Item:', 'westio'),
            'all_items'             => __('All Items', 'westio'),
            'add_new_item'          => __('Add New Item', 'westio'),
            'add_new'               => __('Add New', 'westio'),
            'new_item'              => __('New Item', 'westio'),
            'edit_item'             => __('Edit Item', 'westio'),
            'update_item'           => __('Update Item', 'westio'),
            'view_item'             => __('View Item', 'westio'),
            'view_items'            => __('View Items', 'westio'),
            'search_items'          => __('Search Item', 'westio'),
            'not_found'             => __('Not found', 'westio'),
            'not_found_in_trash'    => __('Not found in Trash', 'westio'),
            'featured_image'        => __('Featured Image', 'westio'),
            'set_featured_image'    => __('Set featured image', 'westio'),
            'remove_featured_image' => __('Remove featured image', 'westio'),
            'use_featured_image'    => __('Use as featured image', 'westio'),
            'insert_into_item'      => __('Insert into item', 'westio'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'westio'),
            'items_list'            => __('Items list', 'westio'),
            'items_list_navigation' => __('Items list navigation', 'westio'),
            'filter_items_list'     => __('Filter items list', 'westio'),
        );

        $args              = array(
            'label'               => __('Custom shape', 'westio'),
            'description'         => __('Custom shapes', 'westio'),
            'labels'              => $labels,
        ...
        $custon_shapes_cpt = new Pavo_CPT('ele_custom_shapes', $args);
        if (is_admin()) {
    ...
    public function ecs_register_admin_menu() {
        $menu_title = _x('Custom Shapes', 'Elementor Custom Shapes', 'westio');
        add_submenu_page(
            'elementor',
            $menu_title,
            $menu_title,
...
//Westio_Elementor_Custom_Shapes::instance();