...
/**
 * Class Westio_Posttype_Query
 * Wrapper for WP_Query.
 * Used by the various widgets for generating the query, according to the controls added using Westio_Group_Control_Query.
...
class Westio_Posttype_Query {
	...
	/**
	 * Westio_Posttype_Query constructor.
	 *
    ...
    /**
     * Remove all closure-based filters from a given hook.
     *
     * @param string $hook     The name of the filter hook.
     * @param int    $priority The priority of the hook to target.
     */
    private function remove_closure_filters( $hook, $priority = 10 ) {
        global $wp_filter;
    ...
    public static function get_public_post_types( $args = [] ) {
        ...
        $post_types = apply_filters( 'westio/query_content/get_public_post_types', $post_types );
	...
	protected function set_avoid_duplicates() {
		if ( 'yes' === $this->get_widget_settings( 'avoid_duplicates' ) ) {
			...
			$post__not_in = array_merge( $post__not_in, \Westio_Query_Controls::$displayed_ids );
