...
class westio_Elementor_Control_MotionFX extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => esc_html__( 'Scrolling Effects', 'westio' ),
		...
		$fields['transform_origin_x'] = [
			'label' => esc_html__( 'X Anchor Point', 'westio' ),
		...
		$fields['transform_origin_y'] = [
			'label' => esc_html__( 'Y Anchor Point', 'westio' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		foreach ( $active_devices as $device_key ) {
			$device_label = 'desktop' === $device_key ? esc_html__( 'Desktop', 'westio' ) : $active_breakpoint_instances[ $device_key ]->get_label();

			$devices_options[ $device_key ] = $device_label;
		}

		$fields['devices'] = [
			'label' => esc_html__( 'Apply Effects On', 'westio' ),
		...
		$fields['range'] = [
			'label' => esc_html__( 'Effects Relative To', 'westio' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => esc_html__( 'Default', 'westio' ),
				'viewport' => esc_html__( 'Viewport', 'westio' ),
				'page' => esc_html__( 'Entire Page', 'westio' ),
			],
			'condition' => [
				'motion_fx_scrolling' => 'yes',
			],
		...
		$fields['motion_fx_mouse'] = [
			'label' => esc_html__( 'Mouse Effects', 'westio' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => esc_html__( 'Off', 'westio' ),
			'label_on' => esc_html__( 'On', 'westio' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => esc_html__( 'Vertical Scroll', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => esc_html__( 'Up', 'westio' ),
							'negative' => esc_html__( 'Down', 'westio' ),
						],
					],
					'speed' => [
					...
					'affectedRange' => [
						'label' => esc_html__( 'Viewport', 'westio' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'sizes' => [
								'start' => 0,
			...
			'translateX' => [
				'label' => esc_html__( 'Horizontal Scroll', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => esc_html__( 'To Left', 'westio' ),
							'negative' => esc_html__( 'To Right', 'westio' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'westio' ),
			...
			'opacity' => [
				'label' => esc_html__( 'Transparency', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
			...
			'rotateZ' => [
				'label' => esc_html__( 'Rotate', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => esc_html__( 'Mouse Track', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Opposite', 'westio' ),
							'negative' => esc_html__( 'Direct', 'westio' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'westio' ),
			...
			'tilt' => [
				'label' => esc_html__( '3D Tilt', 'westio' ),
				'fields' => [
					'direction' => [
						'label' => esc_html__( 'Direction', 'westio' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => esc_html__( 'Direct', 'westio' ),
							'negative' => esc_html__( 'Opposite', 'westio' ),
						],
					],
					'speed' => [
						'label' => esc_html__( 'Speed', 'westio' ),
