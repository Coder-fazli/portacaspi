...
class Westio_Elementor_MotionFX {
    ...
    public function register_controls_group() {
        \Elementor\Plugin::instance()->controls_manager->add_group_control( 'motion_fx', new Westio_Elementor_Control_MotionFX() );
    }
    ...
    public function add_controls_group_to_element( Element_Base $element ) {
        ...
        $element->add_group_control(
            Westio_Elementor_Control_MotionFX::get_type(),
            [
                'name' => 'motion_fx',
                'selector' => $selector,
                'exclude' => $exclude,
    ...
    public function register_frontend_styles() {
        ...
        wp_register_style(
            'e-motion-fx',
            get_theme_file_uri('inc/elementor/motion-fx/assets/motion-fx' . $suffix . '.css'),
            [],
            WESTIO_VERSION
        );
    }
