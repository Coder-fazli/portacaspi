...
?>
<article <?php post_class('post-style-list', get_the_ID()); ?>>
    <div class="post-inner">
        ...
        <div class="post-content">
            ...
            <h3 class="entry-title">
                <a href="<?php echo esc_url(get_permalink()) ?>" rel="bookmark"><?php echo wp_trim_words(get_the_title(), 10) ?></a>
            </h3>

            <?php westio_post_meta(['show_cat' => false, 'show_author' => false, 'show_date' => true, 'show_comment' => true]); ?>
            ...
            if (!empty($excerpt)) {
                if (isset($settings) && is_array($settings) && isset($settings['hidden_content']) && $settings['hidden_content']) {
                    $show_excerpt = false;
                }
            }

            if ($show_excerpt && !empty($excerpt)) : ?>
                <div class="excerpt-content"><?php echo wp_trim_words($excerpt, 25); ?></div>
            <?php endif; ?>
